...
const FeatureSections: React.FC = () => (
  <>
    ...
    <motion.section
      ...
      className="relative border-1 border-slate-100 flex flex-col md:flex-row-reverse items-center justify-between gap-12 max-w-6xl mx-auto bg-white rounded-2xl p-8 md:p-16 overflow-hidden mb-12"
    >
    ...
    <motion.section
      {...sectionMotionProps}
      style={{ boxShadow: '0 6px 24px 0 rgba(11,32,96,.05)' }}
      className="relative border-1 border-slate-100 flex flex-col md:flex-row items-center justify-between gap-12 max-w-6xl mx-auto bg-white rounded-2xl p-8 md:p-16 overflow-hidden"
    >
    {/* Sunlight Hue Top Right */}
    <div
